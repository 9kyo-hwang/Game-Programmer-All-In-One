...
const uint32_t TableStruct_Struct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::ObjectInfo, _impl_.direction_),
...
const char descriptor_table_protodef_Struct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\002\022\017\n\007Victims\030\003 \003(\004\"\363\001\n\nObjectInfo\022\n\n\002"
  "Id\030\001 \001(\004\022#\n\004Type\030\002 \001(\0162\025.Protocol.EObjec"
  "tType\022%\n\005State\030\003 \001(\0162\026.Protocol.EObjectS"
  ...
  "\014\n\004PosX\030\n \001(\005\022\014\n\004PosY\030\013 \001(\005b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Struct_2eproto = {
    false, false, 355, descriptor_table_protodef_Struct_2eproto,
    "Struct.proto",
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          _internal_set_type(static_cast<::Protocol::EObjectType>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_state(static_cast<::Protocol::EObjectState>(val));
        } else
          goto handle_unusual;
        continue;
